...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trabalhopoo

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trabalhopoo: ${OBJECTFILES}
...
${OBJECTDIR}/configs.o: configs.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/configs.o configs.cpp

${OBJECTDIR}/ecra_inicial.o: ecra_inicial.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ecra_inicial.o ecra_inicial.cpp
